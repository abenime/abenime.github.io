...
import { Home, User, Briefcase, FileText, Mail, Menu, X, Terminal } from 'lucide-react';
import { GlitchText } from '../animations/GlitchText';

const navItems = [
  { path: '/', label: 'home', icon: Home, command: '~/' },
  { path: '/about', label: 'about', icon: User, command: '~/about' },
  { path: '/portfolio', label: 'projects', icon: Briefcase, command: '~/projects' },
        ...
        <div className="flex flex-col h-full p-6">
          ...
          <div className="mb-8">
            <Link to="/" className="flex items-center gap-2">
              ...
              <div>
                <GlitchText text="ABENEZER" className="text-lg font-bold text-primary" glitchOnHover />
                <div className="text-xs text-muted-foreground">software_engineer</div>
              </div>
            </Link>
          </div>
          ...
          <nav className="flex-1">
            <div className="text-xs text-muted-foreground mb-4">// NAVIGATION</div>
